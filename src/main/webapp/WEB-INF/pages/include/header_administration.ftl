...
<html lang="en">
  <head>
    ...
    <!-- Styles -->
    <link href="/sib-spreadsheet-processor/css/bootstrap.css" rel="stylesheet">
    <style type="text/css">
      body {
        padding-top: 60px;
        padding-bottom: 40px;
    ...
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="/sib-spreadsheet-processor/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/sib-spreadsheet-processor/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/sib-spreadsheet-processor/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/sib-spreadsheet-processor/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="/sib-spreadsheet-processor/ico/apple-touch-icon-57-precomposed.png">
  </head>
